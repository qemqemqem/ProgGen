...
def make_example_data_gpt(num_fns = 10):
    def make_fn(i):
        def fn():
            silly_prompt = f"In one sentence, write a {random.choice(['silly', 'arrogant', 'fun', 'crazy', 'stupid', 'dumb', 'smart', 'clever', 'funny', 'fun', 'interesting', 'boring', 'bland'])} story about a {random.choice(['dog', 'bird', 'elephant', 'weasel', 'mongoose', 'cat', 'blue jay', 'stranger', 'wizard'])} who goes on an adventure and finds {random.choice(['gold', 'true love', 'a new friend', 'a new enemy', 'a new home', 'a new family', 'a new job', 'a new life', 'a new purpose', 'a new meaning', 'a new reason to live', 'the greatest treasure of all', 'bees!'])}. Only write one sentence, and write it in the style of {random.choice(['JK Rowling', 'JRR Tolkien', 'Octavia Butler', 'The King James Bible', 'a technical manual', 'hacker leet speak', 'the Spanish language', 'the US Patent Office'])}."
